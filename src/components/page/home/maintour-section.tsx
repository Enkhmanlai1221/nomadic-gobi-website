...
const toursData = [
    ...
    },
    {
        ...
        subtitle: "Explore Mongolia's Natural Wonders",
        days: 10,
        category: "Gobi Desert",
        image: "/main-tour/bayanzag.jpg",
        overview: "10-Day Gobi Desert Adventure: Explore Mongolia's Natural Wonders",
        includes: [
            "Transfers upon arrival and departure",
            "English-speaking guide",
        ...
        itinerary: [
            ...
            {
                day: 2,
                title: "Majestic Chinggis Khaan Equestrian Statue & Terelj National Park",
                desc: "After breakfast star your travel to the Majestic Chinggis Khaan Equestrian Statue, an impressive monument standing 40 meters tall. This iconic statue honors the legendary Mongolian leader, offering panoramic views of the surrounding steppe. After soaking in the historical significance, travel to Terelj National Park, known for its breathtaking granite rock formations, lush green meadows, and tranquil rivers. Experience the serenity of nature in this breathtaking landscape. Overnight: Local ger camp with proper toilet and hot shower.",
                image: "/main-tour/chenghis.jpg"
            },
            {
                day: 3,
                title: "Tsagaan Suvarga (White Stupa) → Middle Gobi",
                desc: "Journey southward into the heart of the Gobi Desert to reach Tsagaan Suvarga, a mesmerizing natural wonder where colorful cliffs rise dramatically from the earth, resembling the ruins of an ancient city. The vibrant layers of sediment create a visual feast. Overnight: Local ger camp with hot shower facilities.",
                image: "/main-tour/tsagaansuvarga.jpg"
            },
            {
                day: 4,
                title: "Yolyn Am (Vulture Valley) → South Gobi",
                desc: "Next, venture to Yolyn Am, a stunning gorge within Gobi Gurvansaikhan National Park. This striking valley is known for its permanent ice fields and rich biodiversity, including various wildlife species. A light hike through the cool, shaded canyon offers a serene escape as you take in the unique geological formations surrounding you. Overnight: Local ger camp with proper toilet and hot shower.",
                image: "/main-tour/yolynam.jpg"
            },
            {
                day: 5,
                title: "Khongor Sand Dunes (Singing Dunes) → South Gobi",
                desc: "Marvel at the spectacular Khongor Sand Dunes, the largest sand dunes in Mongolia, renowned for their ethereal beauty. Listen for the enchanting sounds of the “Singing Dunes,” created by the wind as it flows over the sand. You may also enjoy a memorable camel ride through the endless golden dunes, immersing yourself in the peaceful desert atmosphere. Overnight: Local ger camp with proper toilet and hot shower.",
                image: "/main-tour/sanddunes.jpg"
            },
            {
                day: 6,
                title: "Bayanzag (Flaming Cliffs) → South Gobi",
                desc: "Embark on a fascinating exploration of Bayanzag, or the Flaming Cliffs, famous for their striking red sands that glow beautifully under the sunset. This site holds historical significance as the location where dinosaur fossils were first discovered, offering a glimpse into the earth's ancient past as you wander through this unique landscape. Overnight: Local ger camp with hot shower.",
                image: "/main-tour/bayanzag.jpg"
            },
            {
                day: 7,
                title: "Ongi River & Ongi Monastery Ruins",
                desc: "Travel north to the Ongi River, where the ruins of the once-magnificent Ongi Monastery stand as a testament to Mongolia’s Buddhist heritage. Take in the tranquil river views while learning about the monastery's rich history, and relish the peaceful environment that surrounds this historical site. Overnight: Local ger camp with proper toilet and hot shower.",
                image: "/main-tour/gobidesert.jpg"
            },
            {
                day: 8,
                title: "Baga Gazriin Chuluu → Middle Gobi",
                desc: "Venture to Baga Gazriin Chuluu, an impressive granite rock formation rising from the steppe, creating a dramatic landscape that invites exploration. Late afternoon arrive at a family-run ger camp to unwind amidst the serene surroundings, soaking in the natural beauty that envelops you. Overnight: At ger camp (proper toilet and hot shower).",
                image: "/main-tour/bagachuluu.jpg"
            },
            {
                day: 9,
                title: "Baga Gazriin Chuluu → Relax & Explore",
                desc: "This day is for relaxing and recovering after a long journey by a car. You don’t need to wake up early or rush — enjoy the fresh air and rest as much as you like, with free time to relax until late morning. After lunch we will drive to see the breathtaking beauty of Baga Gazriin Chuluu mountains. Discover the ruins of a hidden 17th-century monastery, explore unique rock formations, and visit a natural spring known for its crystal-clear water. This day is all about connecting with nature and recharging your spirit in this enchanting landscape. Overnight at ger camp (proper toilet and hot shower).",
                image: "/main-tour/bagachuluu.jpg"
            },
            {
                day: 10,
                title: "Drive back to Ulaanbaatar",
                desc: "After breakfast, begin your journey back to Ulaanbaatar, reflecting on the unforgettable experiences and breathtaking landscapes you've encountered. Upon arrival, have a farewell dinner together then check in at the hotel and enjoy free time. The following morning, you will be transferred to the airport for your departure. End of the tour.",
                image: "/main-tour/ulaanbaatar.jpg"
            }
        ]
    },
    {
        id: 6,
        title: "10-Day Central & Northern Mongolia Tour",
        subtitle: "Volcanoes, Crystal-Clear Lakes & Tsaatan Culture",
        days: 10,
        category: "Central & North",
        image: "/main-tour/khorgo.jpg",
        overview: `This unforgettable journey takes you through the diverse and breathtaking landscapes of Central and Northern Mongolia. The tour combines ancient historical sites, volcanic formations, crystal-clear lakes, and a rare cultural experience with the Tsaatan reindeer herders who live deep in the remote mountain taiga. Accommodation is arranged in comfortable hotels in towns and cities, while in the countryside you will stay in traditional ger camps or with local herder families, offering an authentic experience of Mongolian nomadic life and untouched nature. Upon arrival in Ulaanbaatar, our guide and driver will meet you at the airport and transfer you to the hotel. Free time for preparing for the trip next morning.`,
        includes: [
            "Transfers upon arrival and departure",
            "English-speaking guide",
            "Accommodation in UB and during the trip",
            "All meals (guide-prepared meals, local restaurants, and cafés)",
            "Private vehicle with experienced driver",
            "Horse and camel riding",
            "Entrance fees to all National Parks and sightseeing sites",
            "Bottled water provided daily",
            "Sleeping bags and mattresses if you don’t have"
        ],
        excludes: [
            "Travel Insurance",
            "Alcoholic beverages",
        ...
        itinerary: [
            {
                day: 1,
                title: "Elsen Tasarkhai Sand Dunes & Kharkhorin",
                desc: "Begin your journey west from Ulaanbaatar and visit the beautiful Elsen Tasarkhai sand dunes, a unique landscape where sand dunes meet green steppe and forest. This area is often called the “Mini Gobi” and has long been part of traditional nomadic migration routes. Continue to Kharkhorin, the site of the ancient capital of the Mongol Empire founded in the 13th century by Chinggis Khan. Here you will visit the historic Erdene Zuu Monastery, one of Mongolia’s oldest Buddhist monasteries, built with stones from the ruins of the imperial city. Overnight at a hotel.",
                image: "/main-tour/kharkhorum.jpg"
            },
            {
                day: 2,
                title: "Khorgo Volcano & Terkhiin Tsagaan Lake",
                desc: "Travel toward Arkhangai province. On the way, explore the impressive Khorgo volcanic crater, an extinct volcano formed thousands of years ago and surrounded by black lava fields created by ancient eruptions. Continue to the stunning Terkhiin Tsagaan Lake, also known as the “Great White Lake,” famous for its crystal-clear water, birdlife, and peaceful volcanic landscape. Overnight in a ger camp near the lakeshore.",
                image: "/main-tour/terkhiintsagaan.jpg"
            },
            {
                day: 3,
                title: "Journey to Murun Town",
                desc: "Drive north through scenic mountain and forest landscapes toward Murun, the administrative center of Khuvsgul province. Along the way, enjoy views of rivers, valleys, and untouched wilderness that represent northern Mongolia’s pristine natural beauty. Overnight at a hotel.",
                image: "/main-tour/khuvsgullake.jpg"
            },
            {
                day: 4,
                title: "Darkhad Khotgor & Nomadic Family Stay",
                desc: "Continue to UlaanUul soum in the remote Darkhad Khotgor, a vast highland basin known for its rivers, lakes and dense forests. This region has been home to reindeer herding cultures for centuries. Experience traditional Mongolian hospitality during an overnight stay with a local herder family, learning about daily nomadic life, livestock herding, and rural customs.",
                image: "/main-tour/khorgo.jpg"
            },
            {
                day: 5,
                title: "Horseback Ride to the Tsaatan Reindeer Herders",
                desc: "Today we will start our tour to Tsaatan reindeer herder families. Ride horses for approximately 2 hours through mountain and taiga trails to reach the Tsaatan reindeer herder families, one of the last reindeer herding cultures in the world. They have preserved an ancient way of life closely connected to nature, using reindeer for transport, milk, and cultural traditions. Spend the day learning about their lifestyle, visiting their camps, enjoying untouched taiga scenery, and taking photographs or videos. Overnight in a traditional Tsaatan teepee-style tent (urtz).",
                image: "/main-tour/taiga.jpg"
            },
            {
                day: 6,
                title: "Return by Horse & Drive to Khuvsgul Lake",
                desc: "After breakfast, ride horses back the same route to the herder family. Continue by vehicle to the famous Khuvsgul Lake, often called the “Blue Pearl of Mongolia.” The lake holds nearly 70% of Mongolia’s fresh water and is surrounded by high mountains and taiga forest. Overnight in a lakeside ger camp, enjoying the peaceful natural environment.",
                image: "/main-tour/khuvsgullake.jpg"
            },
            {
                day: 7,
                title: "Khuvsgul Lake Walk & Return to Murun",
                desc: "Enjoy a relaxing walk along the shore of Khuvsgul Lake, breathing the pure mountain air and experiencing the silence of northern Mongolia’s wilderness. After lunch, return to Murun and stay at a hotel. On the way, visit the ancient Uushgiin Uvur Deer Stones complex — Bronze Age monuments carved with deer and symbolic imagery believed to be connected to early nomadic spiritual beliefs and warrior culture. Overnight at hotel.",
                image: "/main-tour/khuvsgullake.jpg"
            },
            {
                day: 8,
                title: "Drive toward Bulgan Province",
                desc: "Today we begin the journey south toward Bulgan province, traveling through beautiful forest-steppe transition zones that show the diversity of Mongolia’s landscapes. Overnight at the local hotel.",
                image: "/main-tour/gobidesert.jpg"
            },
            {
                day: 9,
                title: "Return to Ulaanbaatar",
                desc: "Drive back to Ulaanbaatar city, passing rivers, mountains, and open steppe scenery along the way. Upon arrival, transfer to your hotel and enjoy free time for rest or independent exploration.",
                image: "/main-tour/ulaanbaatar.jpg"
            },
            {
                day: 10,
                title: "Ulaanbaatar City Tour",
                desc: "Enjoy a guided Ulaanbaatar city tour, visiting major cultural and historical highlights such as Gandan Monastery, Sukhbaatar Square, and Chinggis Khan Museum, providing insight into Mongolia’s past, religion, and modern development. Have a farewell dinner together then check in at the hotel and enjoy free time. The following morning, you will be transferred to the airport for your departure. End of the tour.",
                image: "/main-tour/ulaanbaatar.jpg"
            }
        ]
    },
    {
        id: 7,
        title: "8-DAY GOBI DESERT TOUR",
        subtitle: "Mongolia’s Iconic Gobi Landscapes",
        days: 8,
        category: "Gobi Desert",
        image: "/main-tour/bagachuluu.jpg",
        overview: "This 8-day journey takes you through Mongolia’s most iconic Gobi Desert landscapes, featuring unique natural formations, historical sites, and authentic local experiences. Throughout the tour, accommodation will be provided at comfortable local ger camps equipped with proper toilets and hot showers.",
        includes: [
            "Transfers upon arrival and departure",
            "English-speaking guide",
            "Accommodations during the trip",
        ...
        itinerary: [
            ...
            {
                day: 2,
                title: "Chinggis Khaan Equestrian Statue → Baga Gazriin Chuluu",
                desc: "Today we will start our travel to the Majestic Chinggis Khaan Equestrian Statue at Tsonjin Boldog. Standing at an awe-inspiring 40 meters, this statue commemorates the legendary Mongolian leader and offers stunning views of the surrounding steppe. After exploring the museum and taking in the grandeur, continue your journey to Baga Gazriin Chuluu, a stunning granite rock formation that rises dramatically from the expansive steppes. Here, you can wander through narrow rock passages, discover scenic viewpoints, and explore the remnants of history hidden among the rocks. Overnight: Local ger camp with proper toilet and hot shower.",
                image: "/main-tour/bagachuluu.jpg"
            },
            {
                day: 3,
                title: "Yolyn Am (Vulture Valley)",
                desc: "Travel to Yolyn Am, a remarkable deep gorge nestled in Gobi Gurvansaikhan National Park. This breathtaking valley is renowned for its permanent ice fields that persist even in summer and its rich biodiversity, including various wildlife species. A light hike through the canyon will lead you through picturesque landscapes teeming with life, offering a serene experience away from the rush of modernity. Overnight: Local ger camp with proper toilet and hot shower.",
                image: "/main-tour/yolynam.jpg"
            },
            {
                day: 4,
                title: "Khongor Sand Dunes (Singing Dunes)",
                desc: "Khongoryn Els, or the “Singing Sands,” are Mongolia's largest and most spectacular sand dunes in the Gobi Desert, famous for the deep humming sound they make in the wind and their breathtaking golden waves rising dramatically from the desert floor. Stretching over 180 km long, these massive dunes, part of Gobi Gurvansaikhan National Park, reach up to 300 meters high, offering panoramic views and contrasting with nearby oases nourished by the Khongor River. Experience camel riding with local nomads, walk to Seruun Bulag (Cool Spring) hidden between the dunes, and climb the golden sand hills to watch a stunning sunset over the Gobi Desert. Overnight: Local ger camp with proper toilet and hot shower.",
                image: "/main-tour/sanddunes.jpg"
            },
            {
                day: 5,
                title: "Khongor Sand Dunes (Singing Dunes) → Full Day",
                desc: "Full day at Khongor Sand Dunes to explore more of the area, enjoy optional camel riding, walk around the oasis, and capture unforgettable views of the dunes and desert landscapes. Overnight: Local ger camp with proper toilet and hot shower.",
                image: "/main-tour/sanddunes.jpg"
            },
            {
                day: 6,
                title: "Bayanzag (Flaming Cliffs)",
                desc: "Explore Bayanzag, also known as the Flaming Cliffs, a world-famous paleontological site where dinosaur fossils and eggs were first discovered. The red sandstone cliffs glow beautifully at sunset. The name “Bayan Zag” means “rich in saxaul” in Mongolian, referring to a thorny shrub that grows in the area. The area was nicknamed the “Flaming Cliffs” by American paleontologist Roy Chapman Andrews in the 1920s due to the cliffs' vibrant orange and red color at sunset. Overnight: Local ger camp with hot shower facilities.",
                image: "/main-tour/bayanzag.jpg"
            },
            {
                day: 7,
                title: "Tsagaan Suvarga (White Stupa)",
                desc: "Drive south into the Gobi Desert to Tsagaan Suvarga, a spectacular escarpment formed by wind and water erosion. Its colorful layered cliffs resemble the ruins of an ancient city and offer breathtaking views, especially at sunset. Once the floor of an ancient ocean, the escarpment is composed of sedimentary rock layers that built up over millions of years. Wind and water erosion have shaped the cliffs into vivid layers of white, yellow, purple, orange, and red rock. The cliffs stretch for about 400 meters in length and reach a height of up to 60 meters.",
                image: "/main-tour/tsagaansuvarga.jpg"
            },
            {
                day: 8,
    ...
    {
        id: 8,
        title: "CENTRAL MONGOLIA TOUR",
        subtitle: "7-Day Central Mongolia Highlights Tour",
        days: 7,
        category: "Central & North",
        image: "/main-tour/orkhon.jpg",
        overview: "This 7-day journey takes you through the cultural heart and diverse natural landscapes of Central Mongolia. The tour combines semi-desert sand dunes, wide steppe valleys, waterfalls shaped by ancient volcanic activity, natural hot springs, volcanic lakes, and important historical sites of the Mongol Empire. Accommodation throughout the trip will be in comfortable local ger camps equipped with proper toilets and hot showers, offering an authentic yet convenient Mongolian experience.",
        includes: [
            "Transfers upon arrival and departure",
            "English-speaking guide",
            "All accommodations during the trip",
        ...
        itinerary: [
            ...
            },
            {
                day: 2,
                title: "Elsen Tasarkhai (Mini Gobi)",
                desc: "After breakfast, drive west from Ulaanbaatar to Elsen Tasarkhai, commonly known as the “Mini Gobi.” This unique area showcases an unusual combination of golden sand dunes, green grasslands, and forested hills in one location. You will have time to walk on the dunes, enjoy the vast open scenery, and experience a camel ride led by local nomadic herders. Overnight: Local ger camp with proper toilet and hot shower.",
                image: "/main-tour/sanddunes.jpg"
            },
            {
                day: 3,
                title: "Orkhon Waterfall (UNESCO Site)",
                desc: "Continue driving to the Orkhon Valley, a UNESCO World Heritage Site recognized for its outstanding cultural landscape and long history of nomadic civilization. Visit the Orkhon Waterfall, created by ancient volcanic eruptions and lava flows thousands of years ago. Enjoy a leisurely walk along the Orkhon River, surrounded by wide grasslands and dramatic basalt cliffs. Overnight: Local ger camp with proper toilet and hot shower.",
                image: "/main-tour/orkhon.jpg"
            },
            {
                day: 4,
                title: "Tsenkher Hot Springs",
                desc: "Drive to Tsenkher Hot Springs, one of Mongolia’s most famous natural geothermal areas. The hot springs are rich in minerals and are believed to have therapeutic benefits. Spend the afternoon relaxing in the outdoor hot pools, surrounded by forested hills and fresh mountain air. Overnight: Local ger camp with hot shower facilities.",
                image: "/main-tour/khorgo.jpg"
            },
            {
                day: 5,
                title: "Terkhiin Tsagaan Lake (White Lake)",
                desc: "Travel north to Terkhiin Tsagaan Lake, also known as White Lake, a scenic freshwater lake formed by volcanic activity. The surrounding landscape features lava fields, extinct volcanoes, and open steppe. Enjoy a peaceful walk along the lakeshore and take in the quiet atmosphere of this remote natural area. Overnight: Local ger camp with proper toilet and hot shower.",
                image: "/main-tour/terkhiintsagaan.jpg"
            },
            {
                day: 6,
                title: "Kharkhorin (Karakorum)",
                desc: "Drive to Kharkhorin, the ancient capital of the Mongol Empire during the 13th century. Visit Erdene Zuu Monastery, the oldest surviving Buddhist monastery in Mongolia, surrounded by ancient stone walls and stupas. Explore the remains of Karakorum and learn about the history of Genghis Khan and the Mongol Empire. Overnight: Local ger camp with proper toilet and hot shower.",
                image: "/main-tour/kharkhorum.jpg"
            },
            {
                day: 7,
                title: "Drive back to Ulaanbaatar",
                desc: "After breakfast, drive back to Ulaanbaatar. Arrival in the city in the late afternoon. Upon arrival, have a farewell dinner together then check in at the hotel and enjoy free time. The following morning, you will be transferred to the airport for your departure. End of the tour.",
                image: "/main-tour/ulaanbaatar.jpg"
            }
        ]
    }
...
export default function MainTourSection() {
    ...
    const categories = useMemo(() => {
        // data дотор байгаа category-оос автоматаар гаргаж байна
        const set = new Set(toursData.map((t) => t.category));
        return ["All Regions", ...Array.from(set).filter((c) => c !== "All Regions")];
    }, []);

    const filteredTours = useMemo(() => {
        return activeCategory === "All Regions"
            ? toursData
                                ...
                                <button
                                    ...
                                    className={[
                                        ...
                                        activeCategory === c
                                            ...
                                            : "bg-white/70 text-stone-700 border-stone-200 hover:border-stone-300 hover:bg-white",
                                    ].join(" ")}
                                >
                                    {c}
                                </button>
